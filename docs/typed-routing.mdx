...
Define each route as a class extending `GoRouteData`, which provides shared methods to override
for various scenarios described elsewhere in this proposal.
