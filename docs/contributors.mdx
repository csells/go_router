...
- [johnpryan](https://github.com/johnpryan) for updating implementation to use
  logging package for debug diagnostics
- [nullrocket](https://github.com/nullrocket) for removing a hack for notifying
  the router of a route change that was no longer needed and adding support for
  `Router.neglect`.
- [toshi-kuji](https://github.com/toshi-kuji) for the Japanese translation
  of the docs and catching many typos in the English docs