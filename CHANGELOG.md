### 2.0.0
- TODO: BREAKING CHANGE and [Fix
  #50](https://github.com/csells/go_router/issues/50): split `params` into
  `params` and `queryParams`; see the [Migrating to 2.0 section of the
  README](https://pub.dev/packages/go_router#migrating-to-2-0) for instructions
  on how to migrate your code from 1.x to 2.0
